...
// if($_SESSION['login']['Level'] == 'administrator'){
//     exit(header("location:index.php?page=buku"));
// }
                        ...
                        <tbody>
                            <?php foreach($data->getData() as $rows) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger rounded" href="?page=kategori&act=deleteCat&id=<?= $rows["KategoriID"] ?>" onclick="return confirm('Hapus kategori ?')"><i class="fa fa-trash"></i></a>
