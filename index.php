...
<body class="login" style="background-image:url('assets/image/background_files/background2.png')">
    ...
    <div class="login_wrapper">
        ...
        <section class="login_content ">
           <div class="card "style="background-color:#00008b">
            ...
            <h3 class="text-center font-weight-light my-4 text-light" >Login Perpustakaan Digital</h3>
            <div>
